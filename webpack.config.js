...
//process.env.NODE_ENV . to setup environemnt variable for setting up testing database.
// process.env.NODE_ENV is production in heroku. string test in testing envion. and if both does not exists it is development.
